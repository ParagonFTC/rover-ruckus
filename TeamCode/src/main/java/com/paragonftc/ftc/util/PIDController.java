...
public class PIDController {
    ...
    /**
     *Run a single iteration of the feedback update with the provided error
     *
     * @param error
    ...
    public double update(double error, double time) {
        ...
        //bound output
        if (outputBounded) {
            update = com.qualcomm.robotcore.util.Range.clip(update, minOutput, maxOutput);
        }
